...
class isys_cmdb_ui_category_s_layer2_net_assigned_ports extends isys_cmdb_ui_category_specific
{
    ...
    public function process_list(
        ...
        $l_dao_list = isys_cmdb_dao_list_cats_layer2_net_assigned_ports::build($p_cat->get_database_component(), $p_cat);
        ...
        $this->list_view("isys_cats_layer2_net_assigned_ports_list", $l_obj_id, $l_dao_list, null, null, null, true, true, C__RECORD_STATUS__NORMAL);
