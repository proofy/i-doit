<table cellpadding="0" cellspacing="" border="0">
	<tr>
		<th colspan="2" class="navigation">
			...
			<table width="100%" cellpadding="0" cellspacing="2" border="0">
				<tr>
					<td nowrap="nowrap" class="bookmarkButton" onClick="mysearch_addCriterias();">
					...
					<td nowrap="nowrap" class="bookmarkButton" onClick="mysearch_delCriterion();">
					...
					<td nowrap="nowrap" style="width:25px;text-align:center;" class="bookmarkButton" onClick="mysearch_close();">
						<span>X</span>
					</td>
				</tr>
			</table>
	...
	<tr>
		<td width="13%" align="right">
			<input type="checkbox" name="mysearchSelection[[{$id}]]" />
		</td><td>
