<fieldset class="overview">
	...
	<table class="contentTable">
        ...
        <tr>
            ...
            <td class="value pl10">
				<select name="" id="ocs_overwrite_hostaddress_port_single">
	...
	<fieldset class="overview">
		...
		<p class="p10">
			...
			<label><input type="checkbox" class="categories" checked="checked" name="category[]"
			       value="operating_system" /> [{isys type="lang" ident=LC__OBJTYPE__OPERATING_SYSTEM}]</label><br />
			<label><input type="checkbox" class="categories" checked="checked" name="category[]"
...
<div class="m5">
	...
	[{isys type="f_button" icon="images/icons/silk/database_copy.png" p_strValue="LC__UNIVERSAL__IMPORT" p_bEditMode="1" p_onClick="ocs_import($C__OCS__ID, $('C__OCS__OBJ_TYPE').value, false);"}]
</div>
